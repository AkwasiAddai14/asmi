...
import CalenderM from '@/app/dashboard/bedrijven/calender/maand';
import CalenderW from '@/app/dashboard/bedrijven/calender/week';
import CalenderY from '@/app/dashboard/bedrijven/calender/jaar';
import CalenderD from '@/app/dashboard/bedrijven/calender/dag';
  ...
  return (
    ...
    <div className="flex items-center">
      ...
      <Menu as="div" className="relative">
            ...
            <button
              type="button"
              className="ml-6 rounded-md bg-sky-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-500  focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
            ...
            <button
              type="button"
              className="ml-6 rounded-md bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500  focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
