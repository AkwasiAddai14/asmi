...
import { haalGeplaatsteDiensten, verwijderDienstenZonderOpdrachtnemers } from '@/lib/actions/vacature.actions';
              ...
              >
                ...
                <div className="flex-auto">
                  ...
                  <p className="mt-0.5">
                    ...
                    Bezetting: {' '} {dienst.opdrachtnemers.length} werknemers
                  </p>
                </div>
                <Menu as="div" className="relative opacity-0 focus-within:opacity-100 group-hover:opacity-100">
                  ...
                  >
                    <div className="py-1">
                      <MenuItem>
                        <ElButton link={`/dashboard/shift/bedrijf/${dienst.vacature}`} buttonText="Bekijk"/>
                      </MenuItem> 
                      <MenuItem>
                        <button
                          onClick={() =>
