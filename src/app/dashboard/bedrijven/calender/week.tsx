...
>
  {diensten.map((dienst) => {
    const startTime = parseShiftTime(dienst.datum, dienst.werktijden.begintijd);
    const endTime = parseShiftTime(dienst.datum, dienst.werktijden.eindtijd);
    ...
    return (
      ...
      >
        <a
          href={`/dashboard/shift/bedrijf/${dienst._id}`}
        ...
        >
          <p className="order-1 font-semibold text-orange-700">{dienst.titel}</p>
