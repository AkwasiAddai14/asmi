...
import Calender from '@/app/dashboard/bedrijven/calender/calender';
...
import { haalFacturen } from '@/lib/actions/factuur.actions';
    ...
    <li key={index} className="col-span-1 flex rounded-md shadow-sm">
      <div className="flex flex-1 items-center justify-between truncate border-b border-gray-200 bg-white">
        <div className="flex-1 truncate px-4 py-2 text-sm">
          ...
          <p className="text-gray-500">{shiftItem.sollicitaties ? shiftItem.sollicitaties.length : 0} Sollicitaties</p>
          <p className="text-gray-500">{shiftItem.titel ?? 0}</p>
          <p className="text-gray-500">{shiftItem.diensten ? shiftItem.diensten.length : 0} Diensten</p>
        </div>
      </div>
