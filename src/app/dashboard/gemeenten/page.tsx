...
import { Disclosure, DisclosureButton, DisclosurePanel, Input, Menu, MenuButton, MenuItem, MenuItems } from '@headlessui/react'
...
import { maakFlexpool } from '@/lib/actions/flexpool.actions';
...
const navigation = [
  ...
  { name: 'Werkzoekende', href: '#', current: false },
  { name: 'Vacatures', href: '#', current: false },
]
            ...
            <div className="border-t border-gray-200 pb-3 pt-4">
              <div className="flex items-center px-4">
                <div className="shrink-0">
                  <img alt="" src={profilePhoto} className="size-10 rounded-full" />
                </div>
                <div className="ml-3">
